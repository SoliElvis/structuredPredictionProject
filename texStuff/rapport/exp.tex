...
were extracted using the fastText library \textbf{CITE THIS}. This library included
...
transformation found in \textbf{CITE THIS}. This transformation consisted in applying
...
\textbf{CITE THIS SHIT} provides a good intuition using maps that are aligned.
...
getting decent results as per Theorem 3 \textbf{CITE THIS SHIT}. We were able to get the following
